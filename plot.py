...
# Load the data
df_768 = pd.read_csv('/home/ronit/MTP/PQC_DDOS/client_metrics_768.csv')
df_1024 = pd.read_csv('/home/ronit/MTP/PQC_DDOS/client_metrics_1024.csv')
df_classical = pd.read_csv('/home/ronit/MTP/PQC_DDOS/client_metrics_classical.csv')

# Plotting
plt.figure(figsize=(10, 6))

# We use the index of the dataframe for the x-axis, assuming one data point per second
plt.plot(df_768.index, df_768['handshake_cycles'], label='MLKEM-768', marker='o', markersize=3, linestyle='-')
plt.plot(df_1024.index, df_1024['handshake_cycles'], label='MLKEM-1024', marker='s', markersize=3, linestyle='-')
plt.plot(df_classical.index, df_classical['handshake_cycles'], label='Classical (X25519)', marker='^', markersize=3, linestyle='-')
...
# Save the plot
plt.savefig('/home/ronit/MTP/PQC_DDOS/comparison_plot.png')
